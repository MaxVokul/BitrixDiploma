...
<div class="foryouall">
    <section class="foryouin">
        ...
        foreach ($arResult["ITEMS"] as $arItem) {
            ...
            ?>
            <div class="rect" href="<?= $arItem['DETAIL_PAGE_URL'] ?>" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
                <img class="rectimg" src="<?= $arItem['PREVIEW_PICTURE']['SRC'] ?>" alt="">
                <div class="recttxt">
                    <h2><?= $arItem['NAME'] ?></h2>
                    <p>
                        <?= $arItem['PREVIEW_TEXT'] ?>
            ...
            if ($counter % 3 == 2 || $counter == count($arResult["ITEMS"]) - 1) {
                echo '</div>';
            }
